...
class MyBot(commands.Bot):
    ...
    def __init__(self):
        print("\nStarting Bot")
        super().__init__(
            command_prefix="/", case_insensitive=True, intents=ds.Intents.all()
        )
    ...
    async def set_random_activity(self):
        ...
        await self.change_presence(
            activity=ds.Activity(type=ds.ActivityType.playing, name=activity_name)
        )
    ...
    async def send_random_greeting(self, channel):
        ...
        """
        greetings = [
            "I am back online. I bet it was another power outage.",
            "Sorry about my outage.",
        ]
